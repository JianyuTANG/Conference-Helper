...
import com.example.myapplication.home.paper.PaperPagerAdapter;
...
public class PaperFragment extends Fragment {
    ...
    PaperPagerAdapter pagerAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final TabLayout tabLayout = view.findViewById(R.id.paper_tab_layout);

        final ViewPager viewPager = view.findViewById(R.id.paper_pager);
        pagerAdapter = new PaperPagerAdapter(
